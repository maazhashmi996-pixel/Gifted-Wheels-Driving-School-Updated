            ...
            <div className="max-w-5xl mx-auto px-6">
                    ...
                    {plans.map((plan, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${plan.recommended ? "bg-slate-700 text-white" : "bg-slate-100 text-slate-700"
                                    }`}>
                                    <Clock className="w-6 h-6" />
                                </div>
                                <h3 className={`text-xl font-bold ${plan.recommended ? "text-slate-200" : "text-slate-600"
                                    }`}>
                                    {plan.title}
                                </h3>
                            </div>
                ...
                >
                    <div className="inline-flex flex-wrap items-center justify-center gap-4 p-4 rounded-3xl bg-white border border-slate-200 shadow-sm">
                        ...
                        <a href="tel:9726328113" className="text-slate-700 font-black hover:underline">
                            Call 972-632-8113
                        </a>
                    </div>
                </motion.div>
