        ...
        <footer className="bg-[#0f172a] pt-20 pb-10 text-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    {/* Column 1: Brand & Identity - Fixed with Logo */}
                    <div className="space-y-6">
                        {/* Text Heading ki jagah PNG Logo add kar diya hai */}
                        <Link href="/" className="inline-block group">
                            <img
                                src="/Final logo.png" // Apne logo ka sahi path yahan likhen
                        ...
                        <p className="text-slate-400 font-medium leading-relaxed max-w-sm">
                            Confidence behind the wheel starts here! Expert female-led guidance for a safer and more confident driving experience.
                        </p>
                        <div className="flex gap-4">
                            {/* Manual Facebook SVG */}
                            <a href="https://www.facebook.com/profile.php?id=61580819650511" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-[#1877F2] transition-all duration-300 group">
                                <svg className="w-5 h-5 fill-current text-white" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                            </a>
                            {/* Manual Instagram SVG */}
                            <a href="https://www.instagram.com/giftedwheelsds?igsh=MTIwY25tN291MHA5YQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-[#E4405F] transition-all duration-300 group">
                                <svg className="w-5 h-5 fill-none stroke-current text-white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <p className="text-slate-300 font-medium break-all text-sm">Giftedwheelsdriving@gmail.com</p>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 bg-blue-500/10 rounded-xl flex items-center justify-center text-blue-400 shrink-0">
